...
export function Hero({ content }: HeroProps) {
  return (
    <section className="grid items-start gap-4 lg:grid-cols-[1.22fr_0.78fr]">
      ...
      <aside
        className="rounded-lg border border-slate-200 bg-white p-5 text-slate-950 shadow-sm shadow-slate-950/[0.04] sm:p-6 lg:p-7"
